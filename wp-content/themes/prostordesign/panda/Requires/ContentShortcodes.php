...
add_shortcode("blockquote_start", "panda_blckquote_start_shortcode_callback");

function panda_blckquote_start_shortcode_callback($atts)
{
    return "<blockquote class=\"info-block\">";
}

add_shortcode("blockquote_end", "panda_blckquote_end_shortcode_callback");

function panda_blckquote_end_shortcode_callback($atts)
{
    return "</blockquote>";
}
