...
foreach ([KT_WP_POST_KEY, KT_WP_PAGE_KEY, Block::KEY] as $postType) {
    $pageShortcodesMetabox = KT_MetaBox::createCustom("$postType-shortcodes-metabox", __("Obsahové zktratky", "PD_ADMIN_DOMAIN"), $postType, "panda_content_shortcodes_metabox_callback", false);
...
{
    echo "<ol>";
    printf("<li><b>[%s columns=\"\"]</b> - <i>%s</i></li>", RowShortCode::TAG, __("Začátek řádku s počtem sloupců", "PD_ADMIN_DOMAIN"));
