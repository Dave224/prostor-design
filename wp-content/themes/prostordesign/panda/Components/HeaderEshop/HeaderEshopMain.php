...
<header class="header-main ">
    ...
    <div class="container">
        ...
        <div class="header-main__top">
            ...
            <a href="<?= get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" class="header-main__user --loged">
                <?= Svg::renderSvg("user"); ?>
            </a>

            <?php get_template_part(COMPONENTS_PATH . "HeaderEshop/HeaderEshopCart"); ?>
