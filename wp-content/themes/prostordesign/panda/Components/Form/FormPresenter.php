...
class FormPresenter extends \KT_Contact_Form_Base_Presenter
{
    const PROCESSED_PARAM = "form-processed";
    ...
    public function process()
    {
        ...
        if (\KT::arrayIssetAndNotEmpty($_POST) && array_key_exists(FormConfig::FORM_PREFIX, $_POST)) {
            $form = $this->getForm();
            ...
            $form->validate();
            if (!$form->hasError()) {
                $values = filter_input(INPUT_POST, FormConfig::FORM_PREFIX, FILTER_DEFAULT, FILTER_REQUIRE_ARRAY);
    ...
    protected function initFieldset()
    {
        ...
        $fieldset = FormConfig::getFieldset();
