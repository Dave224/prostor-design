...
class PostConfig implements Configable
{
    ...
    public static function getSettingsFieldset()
    {
        ...
        $fieldset->addSwitch(self::SETTINGS_CONTENT_CENTER, __("Text na střed:", "PD_ADMIN_DOMAIN"));
        $fieldset->addSwitch(self::SETTINGS_GALLERY_NO_GUTTER, __("Galerie bez mezer:", "PD_ADMIN_DOMAIN"));
