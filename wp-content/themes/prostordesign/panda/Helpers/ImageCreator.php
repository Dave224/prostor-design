...
class ImageCreator
{
    ...
    {
        if ($this->isSrcset()) {
            $SrcsetArray = $this->getSrcset();
            array_shift($SrcsetArray);
            return $Srcset = implode(", ", $SrcsetArray);
        }
    }
    ...
    public function setSrc($Src, $Postfix = "")
    {
        if ($Postfix != "") {
            return $this->Src = $Src . " " . $Postfix;
        } else {
            return $this->Src = $Src;
        }
    }

    public function setSrcWithoutPostfix($Src)
    {
        return $this->Src = $Src;
    }
