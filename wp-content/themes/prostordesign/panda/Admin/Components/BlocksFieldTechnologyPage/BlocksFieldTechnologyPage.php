...
global $post;
$BlocksOrder = get_post_meta($post->ID, TechnologyPageConfig::BLOCK_INPUT);
...
<div id="blocks-field">
    ...
    <input type="text" v-model="BlocksOrder" name="<?= TechnologyPageConfig::FORM_PREFIX; ?>[<?= TechnologyPageConfig::BLOCK_INPUT; ?>]">
