...
global $post;
$BlocksOrder = get_post_meta($post->ID, TechnologyConfig::BLOCK_INPUT);
...
<div id="blocks-field">
    ...
    <input type="text" v-model="BlocksOrder" name="<?= TechnologyConfig::FORM_PREFIX; ?>[<?= TechnologyConfig::BLOCK_INPUT; ?>]">
