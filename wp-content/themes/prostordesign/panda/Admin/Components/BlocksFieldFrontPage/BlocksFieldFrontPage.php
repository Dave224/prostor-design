...
global $post;
$BlocksOrder = get_post_meta($post->ID, FrontPageConfig::BLOCK_INPUT);
...
<div id="blocks-field">
    ...
    <input type="text" v-model="BlocksOrder" name="<?= FrontPageConfig::FORM_PREFIX; ?>[<?= FrontPageConfig::BLOCK_INPUT; ?>]">
