...
global $post;
$BlocksOrder = get_post_meta($post->ID, ServicesConfig::BLOCK_INPUT);
...
<div id="blocks-field">
    ...
    <input type="text" v-model="BlocksOrder" name="<?= ServicesConfig::FORM_PREFIX; ?>[<?= ServicesConfig::BLOCK_INPUT; ?>]">
