...
class uString
{
     ...
     * @return string
     */
    public static function wrapWithSpanBannerHeadline($string, $color, $bgColor)
    {
        $patterns = ["/\*\*(.+?)\*\*/i"];
        $replaces = ["<span style='color: $color; background-color: $bgColor'>$1</span>"];
        return preg_replace($patterns, $replaces, $string);
    }
