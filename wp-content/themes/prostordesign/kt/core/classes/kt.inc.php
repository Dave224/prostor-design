...
class KT
{
     ...
     * @global WP_Query $wp_query
     */
    public static function bootstrapPaginationCustom($previousNext = true, $customClass = null, WP_Query $query = null, $customStyle = null, $urlSuffix = null)
    {
        global $wp_query;
        global $paged;
        $paged = self::tryGetInt($paged) ?: 1;
        ...
        if (self::issetAndNotEmpty($pages) && $pages > 1 && $paged >= $paged) {
            ...
            if ($previousNext) {
                if ($paged > 1) {
                    $TagPrev = __("Předchozí", "PROJECT_ADMIN_DOMAIN");
                    $ImagePrev = "<img src=\"\" data-src=\"" . get_template_directory_uri() . "/images/svg/arrow-small.svg\" alt=\"\" aria-hidden=\"false\" class=\"loaded\" data-was-processed=\"true\">" . $TagPrev;
                    self::theTabsIndent(1, "<li class=\"prev\"><a href='" . get_pagenum_link($paged - 1) . $urlSuffix . "'>$ImagePrev</a></li>", true);
                } else {
                    $TagPrev = __("Předchozí", "PROJECT_ADMIN_DOMAIN");
                    $ImagePrev = "<img src=\"\" data-src=\"" . get_template_directory_uri() . "/images/svg/arrow-small.svg\" alt=\"\" aria-hidden=\"false\" class=\"loaded\" data-was-processed=\"true\">" . $TagPrev;
                    self::theTabsIndent(1, "<li class=\"prev disabled\"><a href='" . get_pagenum_link($paged) . $urlSuffix . "'>$ImagePrev</a></li>", true);
                }
            }
            ...
            if ($previousNext) {
                if ($paged < $pages) {
                    $TagNext = __("Další", "PROJECT_ADMIN_DOMAIN");
                    $ImageNext = $TagNext . "<img src=\"\" data-src=\"" . get_template_directory_uri() . "/images/svg/arrow-small.svg\" alt=\"\" aria-hidden=\"false\" class=\"loaded\" data-was-processed=\"true\">";
                    self::theTabsIndent(1, "<li class=\"next\"><a href='" . get_pagenum_link($paged + 1) . $urlSuffix . "'>$ImageNext</a></li>", true);
                } else {
                    $TagNext = __("Další", "PROJECT_ADMIN_DOMAIN");
                    $ImageNext = $TagNext . "<img src=\"\" data-src=\"" . get_template_directory_uri() . "/images/svg/arrow-small.svg\" alt=\"\" aria-hidden=\"false\" class=\"loaded\" data-was-processed=\"true\">";
                    self::theTabsIndent(1, "<li class=\"next disabled\"><a href='" . get_pagenum_link($paged) . $urlSuffix . "'>$ImageNext</a></li>", true);
                }
            }
    ...
    public static function bootstrapPaginateLinks($previousNext = true, $customClass = null, WP_Query $query = null, $customStyle = null)
    {
        ...
        $paginateLinks = paginate_links([
            ...
            "prev_text" => "<img src=\"\" data-src=\"" . get_template_directory_uri() . "/images/ico/arrow-small.svg\" alt=\"\">",
            "next_text" => "<img src=\"\" data-src=\"" . get_template_directory_uri() . "/images/ico/arrow-small.svg\" alt=\"\">",
        ]);
        if (KT::arrayIssetAndNotEmpty($paginateLinks)) {
            ...
            foreach ($paginateLinks as $index => $link) {
                ...
                $nextClass = self::stringContains($link, "next") ? " class=\"next\"" : "";
                $prevClass = self::stringContains($link, "prev") ? " class=\"prev\"" : "";
