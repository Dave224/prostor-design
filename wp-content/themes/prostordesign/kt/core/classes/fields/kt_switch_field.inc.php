...
class KT_Switch_Field extends KT_Field
{
     ...
     * @return self
     */
    public function __construct($name, $label, $labelYes, $labelNo)
    {
        parent::__construct($name, $label);

        $this->addAttrClass(self::FIELD_TYPE);
        $this->setDefaultValue(self::NO);
        $this->setLabelYes($labelYes);
        $this->setLabelNo($labelNo);
    ...
    {
        $dataOn = $this->getLabelYes();
        $dataOff = $this->getLabelNo();
