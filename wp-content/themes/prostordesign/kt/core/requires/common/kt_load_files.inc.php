...
function kt_core_register_scripts_and_styles_handlers_callback() {
    ...
    wp_register_script(KT_CORE_SCRIPT, path_join(KT_CORE_JS_URL, "kt-core.js"), array(KT_WP_JQUERY_SCRIPT, KT_JQUERY_DATETIMEPICKER_SCRIPT, KT_WP_JQUERY_UI_TOOLTIP_SCRIPT, KT_FORM_VALIDATION_SCRIPT, KT_CHOSEN_SCRIPT), "", true);
